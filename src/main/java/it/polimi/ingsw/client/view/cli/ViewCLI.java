...
public final class ViewCLI implements View {
    ...
    private boolean confirmMenu(List<String> header, boolean cursorShown) throws IOException {
        boolean okSel = false;
    ...
    @Override
    public void updateModel(GameModel model, Set<GameValues> ignored) {display.clear();
    ...
    public void requestMotherNatureMovement(Island[] possibleMovement) {
        try {
            ...
            ModuloNat sel = new ModuloNat(islandNum);
    ...
    public void requestCloudTileSelection(CloudTile[] availableClouds) {
        try {
            ...
            while (true) {
                ...
                for (CloudTile availableCloud : availableClouds) {
